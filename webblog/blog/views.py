...
from .serializers import UserSerializer, BlogSerializer, FriendSerializer
...
class BlogViewSet(viewsets.ModelViewSet):
    queryset = Blog_Articles.objects.all().order_by('-create_time')
    serializer_class = BlogSerializer


class FriendViewSet(viewsets.ModelViewSet):
    queryset = FriendShip.objects.all().order_by('-create_time')
